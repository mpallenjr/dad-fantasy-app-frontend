<template>
  <div id="main">
    ...
    <form>
      ...
      <p><a v-bind:href="result.url"/><span class="image left"><img v-bind:src="result.urlToImage" v-bind:alt="result.description" width=125 height=125></span><a/>{{result.description}}</p>
      <br />
      <br />
      <br />
      </div>
