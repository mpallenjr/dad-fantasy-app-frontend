<template>
  <div id="main">
    ...
    <form>
      ...
      <p><span class="image left"><a v-bind:href="result.url"/><img v-bind:src="result.urlToImage" v-bind:alt="result.description" width=125 height=125> <a/></span>{{result.description}}</p>
      <br />
      <br />
      <br />
      </div>
