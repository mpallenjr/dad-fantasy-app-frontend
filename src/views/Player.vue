<template>
  <div id="main">
    ...
    <form>
      ...
      <p><span class="image left"><img v-bind:href="result.url" v-bind:src="result.urlToImage" v-bind:alt="result.description" width=125 height=125/></span>{{result.description}}</p>
      <br />
      <br />
      <br />
      </div>
